...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<BaseClientService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
void registerServices() {
  ...
  getAndRegisterBaseClientService();
...
MockBaseClientService getAndRegisterBaseClientService() {
  _removeRegistrationIfExists<BaseClientService>();
  final service = MockBaseClientService();
  locator.registerSingleton<BaseClientService>(service);
  return service;
}
// @stacked-mock-create
